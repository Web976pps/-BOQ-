...
# Footer information
st.markdown("---")
st.markdown("**Enhanced A1 PDF Zones/Codes Extractor** - Powered by advanced OCR and geometric analysis")
if ENHANCED_AVAILABLE:
    st.markdown("🔧 Using enhanced extraction pipeline with 600 DPI processing, zone memory management, and confidence scoring")
else:
