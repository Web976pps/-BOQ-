...
def create_comprehensive_csv(zones, codes, associations):
    ...
    csv_data.append({'Zone/Area': '=== GRAND TOTALS ===', 'Code': '', 'Code Type': '', 'Page': '', 'Detection Method': '', 'Count': ''})
...
def main():
    ...
    st.markdown("**Advanced OCR-based extraction of zones and furniture codes from architectural PDFs**")
